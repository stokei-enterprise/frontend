...
export const authUrl = 'https://auth.stokei.com';
export const myAccountUrl = 'https://painel.stokei.com/settings';
export const userSettingsUrl = 'https://painel.stokei.com/settings';
export const checkoutUrl = 'https://checkout.stokei.com';
